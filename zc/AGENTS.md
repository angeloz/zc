...
- [src/zc.c](/Users/azaia/Git/mc/zc/src/zc.c): main application, TUI, filesystem actions, launcher logic, bundle-relative helper discovery.
- [Makefile](/Users/azaia/Git/mc/zc/Makefile): local build, bundle targets, and vendored `zc-kilo` build.
